...
MacBook-Air-11:radia-master37 hideki$ python -V
Python 2.7.16
MacBook-Air-11:radia-master37 hideki$ make all
rm -f /Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a /Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a /Users/hideki/Desktop/Radia-master37/cpp/gcc/radia*.so; \
	rm -rf /Users/hideki/Desktop/Radia-master37/ext_lib/fftw-2.1.5/py/build/;
if [ -d /Users/hideki/Desktop/Radia-master37/.git ]; then rm -f /Users/hideki/Desktop/Radia-master37/env/radia_python/radia*.so && (git checkout /Users/hideki/Desktop/Radia-master37/env/radia_python/radia*.so 2>/dev/null || :); fi;
if [ ! -d "/Users/hideki/Desktop/Radia-master37/ext_lib" ]; then \
	    mkdir /Users/hideki/Desktop/Radia-master37/ext_lib; \
	fi; \
	cd /Users/hideki/Desktop/Radia-master37/ext_lib; \
	...
	make -j8 && cp fftw/.libs/libfftw.a /Users/hideki/Desktop/Radia-master37/ext_lib; \
	cd /Users/hideki/Desktop/Radia-master37; \
	rm -rf /Users/hideki/Desktop/Radia-master37/ext_lib/fftw-2.1.5;
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
host_triplet = i686-apple-darwin19.6.0
ACLOCAL = ${SHELL} /Users/hideki/Desktop/Radia-master37/ext_lib/fftw-2.1.5/missing --run aclocal-1.7
ALLOCA = 
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /Users/hideki/Desktop/Radia-master37/ext_lib/fftw-2.1.5/missing --run tar
AUTOCONF = ${SHELL} /Users/hideki/Desktop/Radia-master37/ext_lib/fftw-2.1.5/missing --run autoconf
...
AUTOHEADER = echo
AUTOMAKE = ${SHELL} /Users/hideki/Desktop/Radia-master37/ext_lib/fftw-2.1.5/missing --run automake-1.7
AWK = awk
CC = cc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/hideki/Desktop/Radia-master37/ext_lib/fftw-2.1.5/missing --run makeinfo
MPICC = cc
MPILIBS = 
OBJEXT = o
PACKAGE = fftw
...
infodir = ${prefix}/info
install_sh = /Users/hideki/Desktop/Radia-master37/ext_lib/fftw-2.1.5/install-sh
...
/Library/Developer/CommandLineTools/usr/bin/ranlib: file: .libs/libfftw.a(fftwf77.o) has no symbols
...
/Library/Developer/CommandLineTools/usr/bin/ranlib: file: .libs/librfftw.a(rfftwf77.o) has no symbols
...
#cd /Users/hideki/Desktop/Radia-master37/cpp/gcc; make -j8 clean lib
cd /Users/hideki/Desktop/Radia-master37/cpp/gcc; make clean lib
rm -f *.o *.so *.a
...
..//src/lib/radentry.cpp:1691:12: warning: using the result of an assignment as
      a condition without parentheses [-Wparentheses]
        if(LocRes = RadObjRecMag(n, pP, pL, pM)) return LocRes;
           ~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~
..//src/lib/radentry.cpp:1691:12: note: place parentheses around the assignment
      to silence this warning
        if(LocRes = RadObjRecMag(n, pP, pL, pM)) return LocRes;
                  ^
           (                                   )
..//src/lib/radentry.cpp:1691:12: note: use '==' to turn this assignment into an
      equality comparison
        if(LocRes = RadObjRecMag(n, pP, pL, pM)) return LocRes;
                  ^
                  ==
..//src/lib/radentry.cpp:1694:12: warning: using the result of an assignment as
      a condition without parentheses [-Wparentheses]
        if(LocRes = RadObjDrwAtr(*n, pRGB, 0.001)) return LocRes;
           ~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
..//src/lib/radentry.cpp:1694:12: note: place parentheses around the assignment
      to silence this warning
        if(LocRes = RadObjDrwAtr(*n, pRGB, 0.001)) return LocRes;
                  ^
           (                                     )
..//src/lib/radentry.cpp:1694:12: note: use '==' to turn this assignment into an
      equality comparison
        if(LocRes = RadObjDrwAtr(*n, pRGB, 0.001)) return LocRes;
                  ^
                  ==
..//src/lib/radentry.cpp:1699:13: warning: using the result of an assignment as
      a condition without parentheses [-Wparentheses]
                if(LocRes = RadMatApl(n, *n, mat)) return LocRes;
                   ~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~
..//src/lib/radentry.cpp:1699:13: note: place parentheses around the assignment
      to silence this warning
                if(LocRes = RadMatApl(n, *n, mat)) return LocRes;
                          ^
                   (                             )
..//src/lib/radentry.cpp:1699:13: note: use '==' to turn this assignment into an
      equality comparison
                if(LocRes = RadMatApl(n, *n, mat)) return LocRes;
                          ^
                          ==
..//src/lib/radentry.cpp:1704:12: warning: using the result of an assignment as
      a condition without parentheses [-Wparentheses]
        if(LocRes = RadObjDivMagPln(n, *n, SbdPar, nSbdPar, FlatNorm, 0)) retur...
           ~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
..//src/lib/radentry.cpp:1704:12: note: place parentheses around the assignment
      to silence this warning
        if(LocRes = RadObjDivMagPln(n, *n, SbdPar, nSbdPar, FlatNorm, 0)) retur...
                  ^
           (                                                            )
..//src/lib/radentry.cpp:1704:12: note: use '==' to turn this assignment into an
      equality comparison
        if(LocRes = RadObjDivMagPln(n, *n, SbdPar, nSbdPar, FlatNorm, 0)...
                  ^
                  ==
..//src/lib/radentry.cpp:1710:13: warning: using the result of an assignment as
      a condition without parentheses [-Wparentheses]
                if(LocRes = RadObjAddToCnt(grp, KeysArr, 1)) return LocRes;
                   ~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
..//src/lib/radentry.cpp:1710:13: note: place parentheses around the assignment
      to silence this warning
                if(LocRes = RadObjAddToCnt(grp, KeysArr, 1)) return LocRes;
                          ^
                   (                                       )
..//src/lib/radentry.cpp:1710:13: note: use '==' to turn this assignment into an
      equality comparison
                if(LocRes = RadObjAddToCnt(grp, KeysArr, 1)) return LocRes;
                          ^
                          ==
...
..//src/core/radapl1.cpp:457:7: warning: comparison of array 'Magn' not equal to
      a null pointer is always true [-Wtautological-pointer-compare]
                if((Magn != 0) && (lenMagn >= 3) && (IndTr != 0)) Transf...
                    ^~~~    ~
1 warning generated.
...
..//src/ext/genmath/gmfft.cpp:187:12: warning: using the result of an assignment
      as a condition without parentheses [-Wparentheses]
        if(result = Make1DFFT(FFT1DInfo)) return result;
           ~~~~~~~^~~~~~~~~~~~~~~~~~~~~~
..//src/ext/genmath/gmfft.cpp:187:12: note: place parentheses around the
      assignment to silence this warning
        if(result = Make1DFFT(FFT1DInfo)) return result;
                  ^
           (                            )
..//src/ext/genmath/gmfft.cpp:187:12: note: use '==' to turn this assignment
...
rm -f *.o
cd /Users/hideki/Desktop/Radia-master37/cpp/py; make python
...
creating build/temp.macosx-10.9-x86_64-3.8/Users/hideki
creating build/temp.macosx-10.9-x86_64-3.8/Users/hideki/Desktop
creating build/temp.macosx-10.9-x86_64-3.8/Users/hideki/Desktop/Radia-master37
creating build/temp.macosx-10.9-x86_64-3.8/Users/hideki/Desktop/Radia-master37/cpp
creating build/temp.macosx-10.9-x86_64-3.8/Users/hideki/Desktop/Radia-master37/cpp/src
creating build/temp.macosx-10.9-x86_64-3.8/Users/hideki/Desktop/Radia-master37/cpp/src/clients
creating build/temp.macosx-10.9-x86_64-3.8/Users/hideki/Desktop/Radia-master37/cpp/src/clients/python
gcc -Wno-unused-result -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -fwrapv -O3 -Wall -arch x86_64 -g -DMAJOR_VERSION=1 -DMINOR_VERSION=0 -I/Users/hideki/Desktop/Radia-master37/cpp/src/lib -I/Users/hideki/Desktop/Radia-master37/cpp/src/ext/auxparse -I/Users/hideki/Desktop/Radia-master37/cpp/src/core -I/Library/Frameworks/Python.framework/Versions/3.8/include/python3.8 -c /Users/hideki/Desktop/Radia-master37/cpp/src/clients/python/radpy.cpp -o build/temp.macosx-10.9-x86_64-3.8/Users/hideki/Desktop/Radia-master37/cpp/src/clients/python/radpy.o
In file included from /Users/hideki/Desktop/Radia-master37/cpp/src/clients/python/radpy.cpp:12:
/Users/hideki/Desktop/Radia-master37/cpp/src/clients/python/pyparse.h:770:89: warning: 
      conversion from string literal to 'char *' is deprecated
      [-Wc++11-compat-deprecated-writable-strings]
  ...PyObject* SetDataListsNested(T*& ar, int* arDims, char* cType="d") //OC1...
                                                                   ^
1 warning generated.
g++ -bundle -undefined dynamic_lookup -arch x86_64 -g build/temp.macosx-10.9-x86_64-3.8/Users/hideki/Desktop/Radia-master37/cpp/src/clients/python/radpy.o -L/Users/hideki/Desktop/Radia-master37/cpp/gcc -L/Users/hideki/Desktop/Radia-master37/ext_lib -lradia -lm -lfftw -o ../gcc/radia.cpython-38-darwin.so
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radentry.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radinter.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radiobuf.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(auxparse.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radapl1.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radapl2.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radapl3.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radapl6.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radapl5.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radapl7.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radsend.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radrec.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radplnr1.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radmater.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radptrj.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radg3d.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radflm.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radvlpgn.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radapl4.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radexpgn.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radintrc.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radg3dgr.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radsbdrc.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radrlmet.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radsbdep.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(gmtrans.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radcast.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radgroup.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radarccu.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radsbdvp.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(triangle.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radplnr2.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(gmfft.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radmamet.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/cpp/gcc/libradia.a(radsbdac.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(executor.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fftwnd.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(planner.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(putils.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(config.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(malloc.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(timer.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(rader.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(generic.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(wisdom.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(twiddle.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_10.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_11.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_12.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_13.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_14.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_15.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_16.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_1.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_2.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_32.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_3.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_4.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_5.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_64.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_6.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_7.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_8.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fn_9.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_10.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_16.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_2.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_32.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_3.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_4.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_5.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_64.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_6.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_7.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_8.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftw_9.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_10.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_11.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_12.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_13.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_14.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_15.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_16.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_1.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_2.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_32.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_3.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_4.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_5.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_64.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_6.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_7.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_8.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(fni_9.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_10.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_16.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_2.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_32.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_3.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_4.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_5.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_64.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_6.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_7.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_8.o)) was built for newer macOS version (10.15) than being linked (10.9)
ld: warning: object file (/Users/hideki/Desktop/Radia-master37/ext_lib/libfftw.a(ftwi_9.o)) was built for newer macOS version (10.15) than being linked (10.9)
...
MacBook-Air-11:radia-master37 hideki$ gfortran
gfortran: fatal error: no input files
compilation terminated.
MacBook-Air-11:radia-master37 hideki$ brew info gcc
==> gcc: stable 13.2.0, HEAD
GNU compiler collection
https://gcc.gnu.org/
/usr/local/Cellar/gcc/11.2.0_3 (2,163 files, 459.6MB) *
  Poured from bottle on 2021-12-20 at 13:42:30
